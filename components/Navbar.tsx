  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-800 bg-slate-950/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 py-4">
        <Link href="/mcgr-framework" className="group flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl border border-blue-400/40 bg-slate-950 shadow-lg shadow-blue-950/30">
            <img
              src="/mcgr-logo.svg"
          ...
          <div className="leading-tight">
            ...
            <p className="text-lg font-black text-white group-hover:text-blue-200 transition">
